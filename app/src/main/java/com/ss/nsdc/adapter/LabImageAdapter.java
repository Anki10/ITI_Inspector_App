...
public class LabImageAdapter extends BaseExpandableListAdapter{

    private Context context;
    private List<String> listDataHeader;
    private Map<String, List<LabImage>> listDataChild;

    public LabImageAdapter(Context context, List<String> listDataHeader,
                           Map<String, List<LabImage>> listChildData) {
...
//        }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        final LabImage technicalImage = (LabImage) getChild(groupPosition, childPosition);
...
//        }
        ...
        if (technicalImage.getPhoto() != null
            ...
            Picasso.with((Context) context).load(Utility.getTempFile(context, "itlab_image_" + groupPosition + "_" + childPosition))
                    .skipMemoryCache()
                    .resize(100, 100)
...
*/
        ...
        imgCRImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imgCRImage.getTag() != null && ((Integer) imgCRImage.getTag() == R.drawable.upload_pic_36_36)) {
                    ((LabImageActivity) context).selectImage(imgCRImage, groupPosition, childPosition);
                } else {
                    Intent intent = new Intent(context, FullScreenImageViewActivity.class);
                    //if (classroom.isImageChanged()) {
                    intent.putExtra("imgUrl",  "itlab_image_" + groupPosition + "_" + childPosition);
                        /*} else {
        ...
        imageCRRemark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((LabImageActivity) context).createRemarkDialog(groupPosition, childPosition);
            }
        });
        ...
        imageCRNotSubmitted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((LabImageActivity) context).saveClassrooms(groupPosition, childPosition);
            }
        });
        ...
        imgTechNC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((LabImageActivity)context).changeNC(groupPosition,childPosition,ncValue);
            }
        });
