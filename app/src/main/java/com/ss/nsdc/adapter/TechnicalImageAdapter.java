...
public class TechnicalImageAdapter extends BaseExpandableListAdapter {



    private Context context;
    private List<String> listDataHeader;
    private Map<String, List<TechnicalImage>> listDataChild;

    public TechnicalImageAdapter(Context context, List<String> listDataHeader,
                             Map<String, List<TechnicalImage>> listChildData) {
...
//        }
    ...
    public View getChildView(final int groupPosition, final int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        final TechnicalImage technicalImage = (TechnicalImage) getChild(groupPosition, childPosition);
...
//        }
        ...
        if (technicalImage.getPhoto() != null
            ...
            Picasso.with((Context) context).load(Utility.getTempFile(context, "tech_image_" + groupPosition + "_" + childPosition))
                    .skipMemoryCache()
                    .resize(100, 100)
...
*/
        ...
        imgCRImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imgCRImage.getTag() != null && ((Integer) imgCRImage.getTag() == R.drawable.upload_pic_36_36)) {
                    ((TechnicalImageActivity) context).selectImage(imgCRImage, groupPosition, childPosition);
                } else {
                    Intent intent = new Intent(context, FullScreenImageViewActivity.class);
                    //if (classroom.isImageChanged()) {
                    intent.putExtra("imgUrl",  "tech_image_" + groupPosition + "_" + childPosition);
                        /*} else {
        ...
        imageCRRemark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((TechnicalImageActivity) context).createRemarkDialog(groupPosition, childPosition);
            }
        });
        ...
        imageCRNotSubmitted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((TechnicalImageActivity) context).saveClassrooms(groupPosition, childPosition);
            }
        });
        ...
        imgTechNC.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ((TechnicalImageActivity)context).changeNC(groupPosition,childPosition,ncValue);
            }
        });
