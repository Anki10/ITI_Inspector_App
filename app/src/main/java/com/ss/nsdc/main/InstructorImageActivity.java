...
public class InstructorImageActivity extends BaseActivity {
    ...
    List<InstructorImage> lstInstructorToBeSync=new ArrayList<>();
    Activity currentActivity;
    List<InstructorImage> technical = null;
    String responseCode = null;
    JSONObject responseObj = null;

    Map<String, List<InstructorImage>> technicalMap;
    List<String> headers;
    ...
    InstructorImageAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentActivity = InstructorImageActivity.this;
        ...
        actionBar.setTitle("Instructor Staff Document");
    }
    ...
    public boolean isMandatoryFields(int position) {
        ...
        List<InstructorImage> classrooms = technicalMap.get(headers.get(position));

        for (InstructorImage classroom : classrooms) {
            if (classroom == null) {
                continue;
            }
    ...
    public void saveClassrooms(int jobIndex, int imagePos) {
        if (Validator.isNetworkAvailable(currentActivity)) {
            ...
            lstInstructorToBeSync = uploadImagesDAO.getUnsavedInstructorImageInfobyYearwiseCollegeId(yearWiseCollegeId,
...
//                InstructorImage technicalImage= technicalMap.get(headers.get(jobIndex)).get(imagePos);
...
//            }
        ...
        buttonRemark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRemark()) {
                    ...
                    imagesDAO.updateInstructorDetails(technicalMap.get(headers.get(index)).get(imagePosition));
                    imagesDAO.close();
                    cancelCustomDialog();
                }
            }
    ...
    public boolean isMandatoryFields() {
        ...
        for (InstructorImage classroom : technical) {
            if (classroom == null) {
                continue;
            }
    ...
    private void cameraIntent() {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(Utility.getTempFile(this, "ins_image_" + index + "_" + imagePosition)));
    ...
    private void onCaptureImageResult(Intent data) {
        ...
        final File file = Utility.getTempFile(this, "ins_image_" + index + "_" + imagePosition);
    ...
    public void emptyImageProp() {
        List<InstructorImage> classroomList = technicalMap.get(headers.get(index));
        if (classroomList == null) {
            return;
        }

        for (InstructorImage classroom : classroomList) {
            if (classroom == null) {
                continue;
            }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(currentActivity)
                ...
                .setPositiveButton(R.string.submit_later, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        InstructorImageActivity.this.finish();
                    }
                })
    ...
    private class GetInstructor extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            technical = uploadImageDAO.getInstructorImageInfobyYearwiseCollegeId(yearWiseCollegeId);
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response != null && response) {
                if (technical != null) {
                    List<InstructorImage> classroomList;
                    ...
                    adapter = new InstructorImageAdapter(currentActivity, headers, technicalMap);
    ...
    private class SaveInstructor extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                GeneralDetailsJsonObj.put("IntructorStaffDoc", jsonArray);
                ...
                Log.e("str",resultJsonObj.toString());


                URL url = new URL(AppConstants.URL_INSTRUCTORSTAFF_IMAGE_UPLOAD);
        ...
        protected void onPostExecute(JSONObject responseCode) {
            ...
            if (responseCode != null && responseCode.optString("status").equals("0")) {
                ITIDBController uploadImageDAO = new ITIDBController(currentActivity);
                boolean bolResult = uploadImageDAO.updateInstructorProcTracker(lstInstructorToBeSync, yearWiseCollegeId);
                uploadImageDAO.close();
                ...
                if (bolResult) {
                    ...
                    Toast.makeText(currentActivity, getString(R.string.alert_ins_saved_successfully), Toast.LENGTH_LONG).show();
...
//                    startActivity(i);
                    ...
                    cancelProgressDialog();
                    alert(InstructorImageActivity.this, "", getString(R.string.alert_network_error), getString(R.string.ok), getString(R.string.cancel), false, false);
                }
...
//
     /*   ITIDBController imagesDAO = new ITIDBController(currentActivity);
        ...
        ITIDBController imagesDAO = new ITIDBController(currentActivity);
        imagesDAO.updateInstructorDetails(technicalMap.get(headers.get(groupPosition)).get(childPosition));
        imagesDAO.close();
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                ...
                if(status == 0){
                    ...
                    Toast.makeText(InstructorImageActivity.this,"Unable to get the Date and Time",Toast.LENGTH_SHORT).show();
                }
