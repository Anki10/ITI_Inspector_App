...
public class LabImageActivity extends BaseActivity {
    ...
    List<LabImage> lstTechnicalToBeSync= new ArrayList<>();
    Activity currentActivity;
    List<LabImage> technical = null;
    String responseCode = null;
    JSONObject responseObj = null;

    Map<String, List<LabImage>> technicalMap;
    List<String> headers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentActivity = LabImageActivity.this;
    ...
    public boolean isMandatoryFields(int position) {
        ...
        List<LabImage> classrooms = technicalMap.get(headers.get(position));

        for (LabImage classroom : classrooms) {
            if (classroom == null) {
                continue;
            }
    ...
    public void saveClassrooms(int jobIndex, int imagePos) {
        if (Validator.isNetworkAvailable(currentActivity)) {
            ...
            lstTechnicalToBeSync = uploadImagesDAO.getUnsavedLabImageInfobyYearwiseCollegeId(yearWiseCollegeId,
...
//                LabImage technicalImage= technicalMap.get(headers.get(jobIndex)).get(imagePos);
...
//            }
        ...
        buttonRemark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRemark()) {
                    ...
                    imagesDAO.updateLabDetails(technicalMap.get(headers.get(index)).get(imagePosition));
                    imagesDAO.close();
                    cancelCustomDialog();
                }
            }
    ...
    public boolean isMandatoryFields() {
        ...
        for (LabImage classroom : technical) {
            if (classroom == null) {
                continue;
            }
    ...
    private void cameraIntent() {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(Utility.getTempFile(this, "itlab_image_" + index + "_" + imagePosition)));
...
//            Intent intent = new Intent(currentActivity, LabImageActivity.class);
...
//            finish();;
    ...
    private void onCaptureImageResult(Intent data) {
        ...
        final File file = Utility.getTempFile(this, "itlab_image_" + index + "_" + imagePosition);
...
//        if(technical.get(index).getPictureType().equalsIgnoreCase("Photograph of Bill of IT lab Equipments")){
//            captureBmp.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
//        }else  if(technical.get(index).getPictureType().equalsIgnoreCase("Photograph of Internet Bill")){
//            captureBmp.compress(Bitmap.CompressFormat.JPEG, 100, bytes);
//        }else {
...
//        }
    ...
    public void emptyImageProp() {
        List<LabImage> classroomList = technicalMap.get(headers.get(index));
        if (classroomList == null) {
            return;
        }

        for (LabImage classroom : classroomList) {
            if (classroom == null) {
                continue;
            }
    ...
    private class GetClassrooms extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            technical = uploadImageDAO.getLabImageInfobyYearwiseCollegeId(yearWiseCollegeId);
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response != null && response) {
                if (technical != null) {
                    ...
                    adapter = new LabImageAdapter(currentActivity, headers, technicalMap);
    ...
    private class SaveClassrooms extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                GeneralDetailsJsonObj.put("ITLabDetails", jsonArray);
                ...
                URL url = new URL(AppConstants.URL_ITLAB_IMAGE_UPLOAD);
        ...
        protected void onPostExecute(JSONObject responseCode) {
            ...
            if (responseCode != null && responseCode.optString("status").equals("0")) {
                ITIDBController uploadImageDAO = new ITIDBController(currentActivity);
                boolean bolResult = uploadImageDAO.updateLabProcTracker(lstTechnicalToBeSync, yearWiseCollegeId);
                uploadImageDAO.close();
                ...
                if (bolResult) {
                    ...
                    Toast.makeText(currentActivity, getString(R.string.alert_lab_details_saved_successfully), Toast.LENGTH_LONG).show();
...
//                    startActivity(i);
                    ...
                    cancelProgressDialog();
                    alert(LabImageActivity.this, "", getString(R.string.alert_network_error), getString(R.string.ok), getString(R.string.cancel), false, false);
                }
    ...
    public void changeNC(int groupPosition,int childPosition, int ncValue)
    {
        ...
        ITIDBController imagesDAO = new ITIDBController(currentActivity);
        imagesDAO.updateLabDetails(technicalMap.get(headers.get(groupPosition)).get(childPosition));
        imagesDAO.close();
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                ...
                if(status == 0){
                    ...
                    Toast.makeText(LabImageActivity.this,"Unable to get the Date and Time",Toast.LENGTH_SHORT).show();
                }
