...
import com.ss.nsdc.adapter.ClassroomImageAdapter;
...
public class ClassroomImageActivity extends BaseActivity {
    ...
    List<ClassroomImage> lstTechnicalToBeSync= new ArrayList<>();
    Activity currentActivity;
    List<ClassroomImage> technical = null;
    String responseCode = null;
    JSONObject responseObj = null;

    Map<String, List<ClassroomImage>> technicalMap;
    List<String> headers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lstTechnical = (ExpandableListView) findViewById(R.id.lstLabDetail);
    ...
    public boolean isMandatoryFields(int position) {
        ...
        List<ClassroomImage> classrooms = technicalMap.get(headers.get(position));

        for (ClassroomImage classroom : classrooms) {
            if (classroom == null) {
                continue;
            }
    ...
    public void saveClassrooms(int jobIndex, int imagePos) {
        if (Validator.isNetworkAvailable(currentActivity)) {
           ...
           ITIDBController uploadImagesDAO = new ITIDBController(currentActivity);
            lstTechnicalToBeSync = uploadImagesDAO.getUnsavedClassroomImageInfobyYearwiseCollegeId(yearWiseCollegeId,
            ...
            if (lstTechnicalToBeSync != null && lstTechnicalToBeSync.size() > 0) {
                SaveClassrooms classrooms = new SaveClassrooms();
...
//                ClassroomImage technicalImage= technicalMap.get(headers.get(jobIndex)).get(imagePos);
...
//            }
        ...
        buttonRemark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRemark()) {
                    ...
                    imagesDAO.updateClassroomDetails(technicalMap.get(headers.get(index)).get(imagePosition));
                    imagesDAO.close();
                    cancelCustomDialog();
                }
            }
    ...
    public boolean isMandatoryFields() {
        ...
        for (ClassroomImage classroom : technical) {
            if (classroom == null) {
                continue;
            }
    ...
    private void cameraIntent() {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(Utility.getTempFile(this, "classroom_image_" + index + "_" + imagePosition)));
    ...
    private void onCaptureImageResult(Intent data) {
        ...
        final File file = Utility.getTempFile(this, "classroom_image_" + index + "_" + imagePosition);
    ...
    public void emptyImageProp() {
        List<ClassroomImage> classroomList = technicalMap.get(headers.get(index));
        if (classroomList == null) {
            return;
        }

        for (ClassroomImage classroom : classroomList) {
            if (classroom == null) {
                continue;
            }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(currentActivity)
                ...
                .setPositiveButton(R.string.submit_later, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ClassroomImageActivity.this.finish();
                    }
                })
                .setNegativeButton(R.string.no, null).show();
    }

    private class GetClassrooms extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            technical = uploadImageDAO.getClassroomImageInfobyYearwiseCollegeId(yearWiseCollegeId);
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response != null && response) {
                if (technical != null) {
                    List<ClassroomImage> classroomList;
                    ...
                    adapter = new ClassroomImageAdapter(currentActivity, headers, technicalMap);
                ...
                Toast.makeText(currentActivity,"There is no data for this particular training section",Toast.LENGTH_SHORT).show();
            }
        }
    }

    private class SaveClassrooms extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                for (int i = 0; i < lstTechnicalToBeSync.size(); i++) {
                    ...
                    jsonObject.put("flag",lstTechnicalToBeSync.get(i).getFlag());
                    jsonObject.put("tradeId",lstTechnicalToBeSync.get(i).getTradeId());
                ...
                GeneralDetailsJsonObj.put("classroomDetailsDoc", jsonArray);
                ...
                URL url = new URL(AppConstants.URL_CLASSROOM_IMAGE_UPLOAD);
        ...
        protected void onPostExecute(JSONObject responseCode) {
            ...
            if (responseCode != null && responseCode.optString("status").equals("0")) {
                ITIDBController uploadImageDAO = new ITIDBController(currentActivity);
                boolean bolResult = uploadImageDAO.updateClassProcTracker(lstTechnicalToBeSync, yearWiseCollegeId);
                uploadImageDAO.close();
                ...
                if (bolResult) {
                    ...
                    Toast.makeText(currentActivity, getString(R.string.alert_classroom_details_saved_successfully), Toast.LENGTH_LONG).show();
...
//                    startActivity(i);
                    ...
                    cancelProgressDialog();
                    alert(ClassroomImageActivity.this, "", getString(R.string.alert_network_error), getString(R.string.ok), getString(R.string.cancel), false, false);
                }
    ...
    public void changeNC(int groupPosition,int childPosition, int ncValue)
    {
        ...
        ITIDBController imagesDAO = new ITIDBController(currentActivity);
        imagesDAO.updateClassroomDetails(technicalMap.get(headers.get(groupPosition)).get(childPosition));
        imagesDAO.close();
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                ...
                if(status == 0){
                    ...
                    Toast.makeText(ClassroomImageActivity.this,"Unable to get the Date and Time",Toast.LENGTH_SHORT).show();
                }
