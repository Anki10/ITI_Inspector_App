			...
			R.string.drawer_close  "close drawer" description 
				...
				*//**
				...
				public void onDrawerClosed(View view) {
					Snackbar.make(view, R.string.drawer_close,
				...
				*//**
				...
				public void onDrawerOpened(View drawerView) {
					Snackbar.make(drawerView, R.string.drawer_open,
							Snackbar.LENGTH_SHORT).show();
				}
			};
		...
		private void addItemsRunTime(NavigationView navigationView) {
			...
			for (int i = 0, count = mNavigationView.getChildCount(); i < count; i++) {
				...
				if (child != null && child instanceof ListView) {
					...
					final HeaderViewListAdapter adapter = (HeaderViewListAdapter) menuView
							.getAdapter();
					final BaseAdapter wrapped = (BaseAdapter) adapter
							.getWrappedAdapter();
