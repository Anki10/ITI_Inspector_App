...
import com.ss.nsdc.adapter.WorkshopImageAdapter;
...
public class WorkshopImageActivity extends BaseActivity {
    ...
    List<Workshop> lstTechnicalToBeSync= new ArrayList<>();
    Activity currentActivity;
    List<Workshop> technical = null;
    String responseCode = null;
    JSONObject responseObj = null;

    Map<String, List<Workshop>> technicalMap;
    List<String> headers;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currentActivity = WorkshopImageActivity.this;
    ...
    public boolean isMandatoryFields(int position) {
        ...
        List<Workshop> classrooms = technicalMap.get(headers.get(position));

        for (Workshop classroom : classrooms) {
            if (classroom == null) {
                continue;
            }
    ...
    public void saveClassrooms(int jobIndex, int imagePos) {
        if (Validator.isNetworkAvailable(currentActivity)) {
          ...
          ITIDBController uploadImagesDAO = new ITIDBController(currentActivity);
            lstTechnicalToBeSync = uploadImagesDAO.getUnsavedWorkshopImageInfobyYearwiseCollegeId(yearWiseCollegeId,
...
//                Workshop technicalImage= technicalMap.get(headers.get(jobIndex)).get(imagePos);
...
//            }
        ...
        buttonRemark.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (isRemark()) {
                    ...
                    imagesDAO.updateWorkshopDetails(technicalMap.get(headers.get(index)).get(imagePosition));
                    imagesDAO.close();
                    cancelCustomDialog();
                }
            }
    ...
    public boolean isMandatoryFields() {
        ...
        for (Workshop classroom : technical) {
            if (classroom == null) {
                continue;
            }
    ...
    private void cameraIntent() {
        ...
        intent.putExtra(MediaStore.EXTRA_OUTPUT, Uri.fromFile(Utility.getTempFile(this, "workshop_image_" + index + "_" + imagePosition)));
...
//            Intent intent = new Intent(currentActivity, WorkshopImageActivity.class);
...
//            finish();
    ...
    private void onCaptureImageResult(Intent data) {
        ...
        final File file = Utility.getTempFile(this, "workshop_image_" + index + "_" + imagePosition);
...
//        if(technical.get(index).getPictureType().equalsIgnoreCase("Photograph of Latest Construction clearance certificate by structural engineer ")){
...
//        }
    ...
    public void emptyImageProp() {
        List<Workshop> classroomList = technicalMap.get(headers.get(index));
        if (classroomList == null) {
            return;
        }

        for (Workshop classroom : classroomList) {
            if (classroom == null) {
                continue;
            }
    ...
    public void onBackPressed() {
        new AlertDialog.Builder(currentActivity)
                ...
                .setPositiveButton(R.string.submit_later, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        WorkshopImageActivity.this.finish();
                    }
                })
    ...
    private class GetClassrooms extends AsyncTask<String, String, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            technical = uploadImageDAO.getWorkshopImageInfobyYearwiseCollegeId(yearWiseCollegeId);
        ...
        protected void onPostExecute(Boolean response) {
            ...
            if (response != null && response) {
                if (technical != null) {
                    ...
                    adapter = new WorkshopImageAdapter(currentActivity, headers, technicalMap);
    ...
    private class SaveClassrooms extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... params) {
            ...
            try {
                ...
                GeneralDetailsJsonObj.put("workShopDoc", jsonArray);
                ...
                URL url = new URL(AppConstants.URL_WORKSHOP_IMAGE_UPLOAD);
        ...
        protected void onPostExecute(JSONObject responseCode) {
            ...
            if (responseCode != null && responseCode.optString("status").equals("0")) {
                ITIDBController uploadImageDAO = new ITIDBController(currentActivity);
                boolean bolResult = uploadImageDAO.updateWorkshopProcTracker(lstTechnicalToBeSync, yearWiseCollegeId);
                uploadImageDAO.close();
                ...
                if (bolResult) {
                    ...
                    Toast.makeText(currentActivity, getString(R.string.alert_Workshop_saved_successfully), Toast.LENGTH_LONG).show();
...
//                    startActivity(i);
                    ...
                    cancelProgressDialog();
                    alert(WorkshopImageActivity.this, "", getString(R.string.alert_network_error), getString(R.string.ok), getString(R.string.cancel), false, false);
                }
...
//
     /*   ITIDBController imagesDAO = new ITIDBController(currentActivity);
        ...
        ITIDBController imagesDAO = new ITIDBController(currentActivity);
        imagesDAO.updateWorkshopDetails(technicalMap.get(headers.get(groupPosition)).get(childPosition));
        imagesDAO.close();
        ...
        protected void onPostExecute(JSONObject result) {
            ...
            try {
                ...
                if(status == 0){
                    ...
                    Toast.makeText(WorkshopImageActivity.this,"Unable to get the Date and Time",Toast.LENGTH_SHORT).show();
                }
